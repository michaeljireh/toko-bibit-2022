      ...
      <div class="mx-auto sm:px-6 lg:px-8">
          <div class="py-4">
              ...
              <div class="mx-auto sm:px-6 lg:px-8 h-screen container">
                ...
                <form method="POST" action="{{ route('process.update', $process->id) }}" enctype="multipart/form-data">
                  <div class="flex justify-between">
                    <div class="w-5/12 mx-5">
                      ...
                      <div class="mb-10 pr-10">
                        <x-forms.upload-image :identifier="'imageOlahan'" :urlFile="'/storage/img/'.$process->image" />                    
                      </div>
                    </div>
                    <div class="w-7/12 mx-5">
                      ...
                      <div class="mb-10">
                          ...
                          <x-forms.input id="process" class="block mt-1 w-full text-gray-900" type="text" name="process" :value="old('process') ?? $process->nama" required autofocus />
                      </div>

                      <div class="mb-10">
                        <x-forms.label for="desc" :value="__('Deskripsi')" />
                        <x-forms.textarea id="desc" class="block mt-1 w-full text-gray-900 h-36" type="text" name="desc" required>{{old('desc') ?? $process->desc}}</x-forms.textarea>
                      </div>
